...
def tetris():
   #CREAMOS LA PANTALLA , E IMPRIMIMOS EN FORMA DE MATRIX BIDIMENCIONAL
    screen = [  [ "🔳","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️",],
                [ "🔳","🔳","🔳","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️",],
                [ "⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️",],
                [ "⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️",],
                [ "⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️","⬜️",],
            ...
            if item == '🔳':
                ...
                match movement:
                    ...
                    case Movement.ROTATE:
                        new_row_index = row_index + rotations[new_rotation][rotation_item][1]
                        new_column_index = column_index + rotations[new_rotation][rotation_item][0]
                        rotation_item += 1
